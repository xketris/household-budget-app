  ...
  return (
    <View className='bg-background flex-1 h-full w-full flex-col justify-center items-center px-16'>
        ...
        <View className='flex-col w-full justify-around items-center gap-5'>
            ...
            <CustomInput placeholder="Email" className="w-full" />
            <CustomInput placeholder="Password" className="w-full" secureTextEntry />
            <CustomInput placeholder="Repeat Password" className="w-full" secureTextEntry />
